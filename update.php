<?php  
	...
	if (!empty($_POST)) {
			...
			$con->apellidos=$_POST["apellidos"];
			$con->telefono=$_POST["telefono"];
			$con->email=$_POST["email"];
			$con->foto=$_POST["foto"];
			$con->observaciones=$_POST["observaciones"];
			...
			<div class="ml-20">
				<form action="" method="post">
					...
					<div class="relative z-0 mb-6 w-3/4 group">
      					<input type="text" name="nombre" class="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="<?=$con->nombre?>" required />
  					...
  					<div class="relative z-0 mb-6 w-3/4 group">
      					<input type="text" name="apellidos" class="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="<?=$con->apellidos?>" required />
  					...
  					<div class="relative z-0 mb-6 w-3/4 group">
      					<input type="text" name="telefono" class="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="<?=$con->telefono?>" required />
  					...
  					<div class="relative z-0 mb-6 w-3/4 group">
      					<input type="email" name="email" class="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="<?=$con->email?>" required />
  					...
  					<div class="relative z-0 mb-6 w-3/4 group">
      					<input type="text" name="foto" class="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="<?=$con->foto?>" required />
